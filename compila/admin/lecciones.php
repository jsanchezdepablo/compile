...
<body class=" theme-blue">
    ...
    <div class="content"> <!-- INICIO CONTENIDO -->
        <div class="header">
            <h1 class="page-title">Todas las Lecciones</h1>
            <ul class="breadcrumb">
                <li><a href="lecciones.php">Lecciones</a> </li>
                <li class="active">Todas las lecciones</li>
            </ul>
        </div>
        <div class="main-content"> <!--CONTENIDO PRINCIAL -->
               
        <div class="btn-toolbar list-toolbar">
            <a class="btn btn-primary" href="leccionAdd.php"><i class="fa fa-plus"></i> Añadir Lección</a>
        </div>
...
<?php 
    function mostrarLecciones(){
        ...
        $sql="SELECT * FROM leccion LIMIT $start,$por_pagina";
        ...
        while($row = mysqli_fetch_assoc($result)) {
            ...
            $sql2="SELECT * FROM curso WHERE curso.Id='".$row['Id_Curso']."'";
            ...
            $fila.='<tr>';
                ...
                $fila.='<td>'.$curso.'</td>';
                $fila.='<td>'.$row["Orden_Int"].'</td>';
                $fila.='<td>';
                    $fila.='<a href="leccionEditar.php?leccion='.$row["Id"].'"><i class="fa fa-pencil"></i> </a>';
    ...
    function paginacion(){
        ...
        //primera pagina
        echo '<li><a href="lecciones.php?pagina=1">&laquo;</a></li>';

        for ($i=1; $i <=$total ; $i++) { 
            echo '<li><a href="lecciones.php?pagina='.$i.'">'.$i.'</a></li>';
        }
        //ultima pagina
        echo '<li><a href="lecciones.php?pagina='.$total.'">&raquo;</a></li>';
        echo '</ul>';
